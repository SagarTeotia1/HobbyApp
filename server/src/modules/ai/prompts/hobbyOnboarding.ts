export interface HobbyOnboardingPromptParams {
  userInput: string;
  popularHobbies: string[];
}

export const buildHobbyOnboardingPrompt = ({
  userInput,
  popularHobbies,
}: HobbyOnboardingPromptParams): string => `You are HobbyForge's onboarding assistant.
